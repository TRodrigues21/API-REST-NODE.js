...
// Manter em ordem da mais expecifica para menos especifica
  .get("/livros", LivroController.listarLivros, paginar) // Rota para listar livros
  .get("/livros/busca", LivroController.listarLivroPorFiltro, paginar) // Rota para listar livro por editora
